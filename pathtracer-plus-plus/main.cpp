...
//const std::string MODEL_PATH = "models/rungholt.obj";
//const std::string TEXTURE_PATH = "textures/rungholt-RGB.png";
const std::string MODEL_PATH = "models/vokselia_spawn.obj";
...
class HelloTriangleApplication {
 ...
 private:
  ...
  void loadModel() {
    ...
    if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, MODEL_PATH.c_str(), MODEL_DIR.c_str())) {
